    ...
    >
      {selectoptions.map((item, index) => {
        return (
          ...
          >
            <button
              className={`${font_Anton.className} text-[22px] uppercase leading-[33.12px]  py-[8px] px-[12px]  md:py-[15px] md:px-[32px] bg-[#343434] rounded-2xl -mt-4 flex items-center justify-center max-w-[328px] w-full h-[95px] group-hover:bg-[#E69244] ${
